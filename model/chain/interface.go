...
type Chain interface {
	DeployModel(configAddress common.StorageAddress, weightsAddress common.StorageAddress, scriptsAddress common.StorageAddress, params common.Hyperparameters) (id common.ModelIdentifier, err error)
	...
	ScriptsAddress(id common.ModelIdentifier) (address common.StorageAddress, err error)
